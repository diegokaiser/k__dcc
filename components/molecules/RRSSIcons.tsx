...
const RRSSIcons = () => {
  return (
    <div className='flex justify-center gap-x-4 mt-4 relative z-10'>
      <Link href='https://github.com/diegokaiser' target='_blank' className='bg-[#0f0f0f]/90 backdrop-blur flex items-center justify-center h-[40px] w-[40px] rounded-full'>
      ...
      <Link href='https://www.linkedin.com/in/diegocaceres/' target='_blank' className='bg-[#0f0f0f]/90 backdrop-blur flex items-center justify-center h-[40px] w-[40px] rounded-full'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className='h-auto w-7/12'>
          <rect width="256" height="256" fill="none"/>
